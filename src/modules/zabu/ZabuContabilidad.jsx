...
  return (
    <>
   {/* ── HEADER FIJO — KPIs + tabs fijos, solo el contenido se desliza */}
   <div style={{ position:'sticky', top:0, zIndex:20, background:'var(--bg)', paddingBottom:'8px', marginBottom:'4px', borderBottom:'1px solid var(--border)' }}>
